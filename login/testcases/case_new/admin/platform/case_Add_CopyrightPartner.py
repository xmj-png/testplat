...
from login.templates.platform.common.Add_CopyRight import add_AudioBookCopyright, add_ReadBookCopyright, \
    add_ComicCopyright
from login.templates.platform.common.Create_Number import create_IDNumber, create_PhoneNum, create_CreditCardNumbers
from login.templates.platform.common.Create_PartnerName import partnerName
from login.templates.platform.common.operate_mysql import billing_delete
