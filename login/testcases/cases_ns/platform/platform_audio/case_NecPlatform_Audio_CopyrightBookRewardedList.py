...
class case_NecPlatform_Audio_Copyright_Book_Rewarded_List(unittest.TestCase):
    def setUp(self):
    ...
    def test_necplatform_audio_copyright_book_rewarded_list(self):
        ...
        # 获取admin接口url
        copyrightBookRewardedList = getAdminName('copyrightBookRewardedList')
        # 获取前端页面的url
        bookReward = getcurrentPath('bookReward')
        # 入参
