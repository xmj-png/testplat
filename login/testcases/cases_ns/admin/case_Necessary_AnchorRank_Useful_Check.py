...
class case_Necessary_Admin_AnchorRank_Useful_Check(unittest.TestCase):

    def test_necessary_admin_anchorrank_useful_check(self):
        """admin主播榜单列表可用检查"""
        # 登录并获取token
        ...
        r = httputils.getadmin(getAdminName('rankingsList'), data, admin_token,
                                      getcurrentPath('AnnouncerRankingList'))
        print(r.text)
