...
def run_test(request):
    ...
    host_names = 'http://earth-api.mting.info,http://earth-admin.lrts.me,http://earth-advert.mting.info'
    ...
    if test_form.is_valid():
        ...
        if envId == '4':
            ...
            host_names = 'http://moon-api.mting.info,http://moon-admin.lrts.me,http://moon-advert.mting.info'
        elif envId == '5':
            host_names = 'http://mars-api.mting.info,http://mars-admin.lrts.me,http://mars-advert.mting.info'
