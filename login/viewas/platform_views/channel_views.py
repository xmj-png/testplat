...
from login.templates.platform.add_Partner.Add_ChannelPartner import add_ChannelPartner
from login.templates.platform.channel_manage.developer_manage import add_channel_by_type, approve_channel_by_id
