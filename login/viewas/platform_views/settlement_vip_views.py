...
from login.templates.platform.settlement.SettlementVIP import SettlementVIP
...
def settlement_vip_result(request):
    ...
    :return:
    '''
    settlement_data = models.settlement_vip_models.objects.filter().order_by('-create_time').values()[0:10]
