...
from login.templates.platform.settlement.SettlementVIP import SettlementVIP, Channel_Settlement
...
def settlement_channel_vip_result(request):
    ...
    :return:
    '''
    settlement_data = models.settlement_channel_vip_models.objects.filter().order_by('-create_time').values()[0:10]
