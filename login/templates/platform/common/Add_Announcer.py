...
from login.templates.platform.common import Create_AnnouncerName
...
def add_Announcer():
    ...
    if json.loads(r.text)['status']==0:
        Announcer_record = select_platform("select * from platform.t_copyright_announcer order by id desc limit 1;") #查询添加后的版权记录
