...
from login.templates.platform.common.Add_ReleaseDivideChannel import add_DivideChannel
...
def add_ChannelPartner(business, partnerType):
    ...
    print(res)
    if res['status'] == 0:
        Channel_partner = select_billing("SELECT * from billing.p_partner order by id desc LIMIT 1;")
