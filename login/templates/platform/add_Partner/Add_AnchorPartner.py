...
from login.templates.platform.common.Add_Announcer import add_Announcer
...
def add_AnchorPartner(business, partnerType):
    ...
    print(res)
    if res['status'] == 0:
        Anchor_partner = select_billing("SELECT * from billing.p_partner order by id desc LIMIT 1;")
