...
def get_conf(title: str, key: str) -> object:
    '''
...
def getdict(title, key):
    '''
        ...
        '''
    config = configparser.RawConfigParser()
    path = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) #os.path.abspath(__file__)返回脚本的绝对路径
    # print('path1',path)
    config.read(path + '/config/config.ini', encoding='utf-8')
